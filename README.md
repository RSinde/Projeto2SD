...
1) In JavaMessages, searchInbox, SQL Query was corrected to use INNER JOIN, instead of RIGHT JOIN.

### To improve support for slower cpus/machines:

1. Timeout values in RestClient increased from 3000 to 10000ms.
